if __name__ == '__main__':
    ...
    input1=input("What do you want the test file to be? ").rstrip()
    input2=input("What should your second catagory be? ").rstrip()
    # Save a test image to a file
    urls = search_images_ddg(input1, max_images=1)
    test_file = Path('silly.jpg')
    ...
    image_categories = [input1, input2]
    path = Path(f"{input1}OR{input2}")
