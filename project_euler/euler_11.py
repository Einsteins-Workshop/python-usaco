...
# The product of these numbers, 26 X 63 X 78 X 14 is 1788696
...
fourinarow=[]
daBeegest=0
for x in range(400-63):
    fourinarow.append(grid[x]*grid[x-1]*grid[x+2]*grid[x+3])
    fourinarow.append(grid[x]*grid[x+20]*grid[x+40]*grid[x+60])
    fourinarow.append(grid[x]*grid[x+21]*grid[x+42]*grid[x+63])
    fourinarow.append(grid[x]*grid[x+19]*grid[x+38]*grid[x+57])
for y in range(len(fourinarow)):
    if fourinarow[y]>daBeegest:
        daBeegest=fourinarow[y]
print(daBeegest)
